...
<input style="text-align:left;" type="password" name="username" placeholder="Old password"/><br /><br />
<input style="text-align:left;" type="password" name="username" placeholder="New password"/><br /><br />
<input style="text-align:left;" type="password" name="username" placeholder="Confirm password"/><br /><br />
